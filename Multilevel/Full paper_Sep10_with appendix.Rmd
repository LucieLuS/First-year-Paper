...
```{r randomization and fishers null p-value, results='hide', echo = FALSE, eval=TRUE, message = FALSE, warning=FALSE}
...
```{r error rate for p-value I produced for non-democracies, results='hide', eval = TRUE, echo = FALSE, message = FALSE, warning=FALSE}
